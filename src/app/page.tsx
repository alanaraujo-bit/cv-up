...
/**
 * Placeholder home for phase 0. It exercises the design system and the PWA
 * install path; it is replaced by the marketing page in phase 10 and by the
 * authenticated redirect in phase 1.
 */
const ROADMAP = [
  { phase: "Fase 0", title: "Fundação e arquitetura", done: true },
  { phase: "Fase 1", title: "Banco de dados e autenticação", done: false },
  { phase: "Fase 2", title: "Shell do app e painel", done: false },
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-14 safe-x sm:py-20">
        <Badge variant="secondary">Fase 0 · Fundação concluída</Badge>
